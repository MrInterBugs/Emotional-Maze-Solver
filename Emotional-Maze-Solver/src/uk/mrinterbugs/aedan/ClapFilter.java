...
private final SampleProvider ss; /** The passed in Sound Sensor */ private long lastHeard; /** Time since last clap heard */
...
timeGap = gap; ss = soundMode; threshold = level; if (!soundMode.getName().startsWith("Sound")) {
...
ss.fetchSample (level , index); if (level[index] >= threshold) {
